...
//    static List<Actor> actorList = new ArrayList<>();
    ...
    static void dataPreparation() {
        Staff stevenSpilberg = new Director("Steven", "Spilberg", 2000);
        Staff jamesCameron = new Director("James", "Cameron", 3000);

        Staff tomCruiz = new Actor("Tom", "Cruiz", 1000);
        Staff juliaRoberts = new Actor("Juila", "Roberts", 1100);
        ...
        Collections.addAll(staffList, tomCruiz, juliaRoberts, stevenSigal);
//        Collections.addAll(directorList, stevenSpilberg, jamesCameron);
    ...
    private static void chceckMovieForActor() {
    ...
    private static void chceckMovieBudget(List<Movie> movieList) {
    ...
    private static void addNewMovie() {
        ...
        System.out.println("Podaj proszę ilu będzie aktorów");
